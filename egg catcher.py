...
win=Tk()
c=Canvas(win,width=canvas_width,height=canvas_height,bg='deep sky blue')
...
color_cycle=cycle(['light blue','pink','purple','orange','light yellow','blue','black'])
egg_width=45
egg_height=55
egg_score=10
egg_speed=500
...
cather_width=100
catcher_height=100
catcher_start_x=canvas_width/2-cather_width/2
catcher_start_y=canvas_height-catcher_height-10
catcher_start_x2=catcher_start_x+cather_width
